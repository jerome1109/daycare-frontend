...
import { groupedTimezones, formatTimezone } from "@/config/timezone";
...
export default function RegisterPage({ plans }: { plans: string }) {
    ...
    <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {step === 1 && (
                  <div className="space-y-4 animate-fadeIn">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="timezone" className="text-sky-600">
                        Timezone
                      </Label>
                      <Select
                          ...
                          {Object.entries(groupedTimezones).map(
                            ([region, zones]) => (
                              <SelectGroup key={region}>
                                <SelectLabel className="px-2 py-1.5 text-sm font-semibold text-sky-700">
                                  {region}
                                </SelectLabel>
                                {zones.map((timezone) => (
                                  <SelectItem
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent className="max-w-[95vw] w-full max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl md:text-3xl font-bold text-sky-700 text-center pb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 py-4">
            ...
            <div className="lg:col-span-3 space-y-4 lg:border-r border-sky-100 lg:pr-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  <span className="font-medium text-sky-700">Timezone</span>
                  <p className="text-sky-600 text-sm">{formData.timezone}</p>
                </div>
            ...
            <div className="lg:col-span-2 bg-sky-50 rounded-lg p-4">
          ...
          <DialogFooter className="flex flex-col sm:flex-row gap-2 pt-4 border-t border-sky-100">
            <Button
              type="button"
              variant="outline"
            ...
            <Button
              ...
              className="w-full sm:flex-1 bg-sky-600 hover:bg-sky-700"
              disabled={loading}
            >
